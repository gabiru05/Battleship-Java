...
import static nombreusuario.Player2.redcells2;
...
public class Player1 extends javax.swing.JFrame {
    ...
    public static Boolean[][] estadoJuego = new Boolean[10][10];
    ...
    public Player1() {
        ...
        initComponents();
        CoordenadasP1.setFocusable(false);
        ...
        if (!BarcosGuardados) {
            ...
            Ataque_Vida(CuadroBarcos, CoordenadasP1);
    ...
    private void initComponents() {
        ...
        Nombre1.setFont(new java.awt.Font("Roboto Black", 1, 24)); // NOI18N
        Nombre1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        Nombre1.setText("JUGADOR 1");
        Juego.add(Nombre1, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 25, 160, 45));
...
public void setTexto(String nombreUsuario1){
    Nombre1.setText(nombreUsuario1);
}
...
public static boolean[][] redcells1 = new boolean[10][10];;
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (text.length() == 3 && text.charAt(1) == ',') {
                ...
                if (x >= 1 && x <= 9 && y >= 1 && y <= 9 && labels[x][y].getText().isEmpty()) {
                    ...
                    for (int i = 1; i <= 9; i++) {
                        for (int j = 1; j <= 9; j++) {
                            if (celdasR2[i][j] && (estadoJuego[i][j] == null || !estadoJuego[i][j])) {
                                allRevealed = false;
                                break;
                            }
                        }
                    ...
                    if (allRevealed) {
                        ...
                        @Override
                        public void actionPerformed(ActionEvent e) {
                            Ganador jugadorr1 = new Ganador();
                            hideFrame();
                            jugadorr1.setVisible(true);
