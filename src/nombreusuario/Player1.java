...
public class Player1 extends javax.swing.JFrame {
    addSound add_sonido_funcion = new addSound();
    ...
    private void Music_botonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_Music_botonActionPerformed
        if (Music_boton.isSelected()) {
            ...
            add_sonido_funcion.SetMusic_icon(Music_icono, "/IMAGENES/music_on.png");
            System.out.println("Icono on");
            Music_icono.repaint();

            // restart sound
            add_sonido_funcion.Setsound();

        } else {
            add_sonido_funcion.SetMusic_icon(Music_icono, "/IMAGENES/music_off.png");
            System.out.println("Icono of");
            Music_icono.repaint();

            // Stop sound
            if (add_sonido_funcion.Sound != null) {
                add_sonido_funcion.Sound.stop();
            }
